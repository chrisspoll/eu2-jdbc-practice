...
public class SpartanGetRequest {
    ...
    String spartanurl = "http://100.25.34.235:8000";
    ...
    public void test1(){
       ...
       /* TASK
        When users sends a get request to /api/spartans/33
    ...
    public void test2(){
        ...
        Response response = given().auth().basic("admin", "admin")
                .when().get(spartanurl + "/api/spartans/33");
        ...
        assertEquals(response.path("name"),"Wilek");
